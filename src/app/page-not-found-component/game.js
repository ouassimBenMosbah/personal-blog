...
(function() {
  ...
  Runner.classes = {
    ...
    INFO_HELP: 'runner-help',
    INFO_COPYRIGHT: 'runner-copyright'
  };
  ...
  Runner.prototype = {
    ...
    onKeyDown: function(e) {
      ...
      if (!this.crashed && !this.paused) {
        if (Runner.keycodes.JUMP[e.keyCode] || e.type == Runner.events.TOUCHSTART) {
          e.preventDefault();
    ...
    /**
     * Whether the game should go into arcade mode. [Edited]
     * @return {boolean}
     */
    isArcadeMode: function() {
      // return document.title == ARCADE_MODE_URL;
      return location.hash == '#arcade';
    },
    ...
    setArcadeMode: function() {
      ...
      var copyright = document.getElementsByClassName(Runner.classes.INFO_COPYRIGHT)[0];
      var help = document.getElementsByClassName(Runner.classes.INFO_HELP)[0];
      help.innerHTML += '<br>' + copyright.innerHTML;
